  ...
  return (
    <div className="svc-scope">
      ...
      <section className="hero">
        <img src="/images/services_3/main.png" alt={t('heroTitle')} className="hero__bg" />
      ...
      <section className="svc">
        ...
        <article className="svc-card_service svc-card_service--blue">
          ...
          <figure className="svc-card_service__media">
            <img src="/images/services_3/block2.png" alt={t('s1.imgAlt')} />
          </figure>
        </article>
        ...
        <article className="svc-card_service svc-card_service--amber svc-card_service--alt">
          <figure className="svc-card_service__media">
            <img src="/images/services_3/block3.png" alt={t('s2.imgAlt')} />
          </figure>
          <div className="svc-card_service__body_service">
        ...
        <article className="svc-card_service svc-card_service--green">
          ...
          <figure className="svc-card_service__media">
            <img src="/images/services_3/block4.png" alt={t('s3.imgAlt')} />
          </figure>
        </article>
        ...
        <article className="svc-card_service svc-card_service--blue svc-card_service--alt">
          <figure className="svc-card_service__media">
            <img src="/images/services_3/block5.png" alt={t('s4.imgAlt')} />
          </figure>
          <div className="svc-card_service__body_service">
        ...
        >
          ...
          <figure className="svc-card_service__media">
            <img src="/images/services_3/block6.png" alt={t('s5.imgAlt')} />
          </figure>
        </article>
      </section>
    </div>
